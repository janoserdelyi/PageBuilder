...
{
public class FileInput : cb.FileInput
{
	...
	public override void Render (
		...
		//ControlUtils.RenderAttribute(Context, sb, base.Name, "accesskey", accesskey);
		...
		//sb.Append(prepareEventHandlers(base.Name));
		//sb.Append(prepareStyles(base.Name));
		//sb.Append(prepareOther(base.Name));
		sb.Append(" />");
